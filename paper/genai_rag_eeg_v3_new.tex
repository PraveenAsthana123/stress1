...
\caption{Confusion matrices for binary stress classification across SAM-40 and EEGMAT datasets. The diagonal dominance indicates strong classification performance with minimal confusion between stress and baseline states.}
