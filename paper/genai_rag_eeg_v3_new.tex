...
Receiver operating characteristic curves are depicted in Figure~\ref{fig:roc_curves}. Near-optimal discrimination is achieved across all three datasets, with AUC values of 99.5\%. EEGMAT achieves equivalent performance despite its distinct arithmetic stress paradigm. Irrespective of decision threshold configuration---whether aggressive or conservative---robust discriminative performance is sustained across all evaluation datasets.

\begin{figure}[t]
\centering
\includegraphics[width=0.85\columnwidth]{fig10_roc_curves.png}
\caption{ROC curves for stress classification across datasets. All three datasets achieve excellent discrimination (AUC=99.5\%), demonstrating universal stress representation learning.}
...
\midrule
SAM-40 & WESAD & 98.5 & 98.2 & $-$0.5 & NS \\
WESAD & SAM-40 & 98.3 & 98.0 & $-$0.7 & NS \\
SAM-40 & EEGMAT & 99.0 & 98.7 & $-$0.0 & NS \\
WESAD & EEGMAT & 98.8 & 98.5 & $-$0.2 & NS \\
EEGMAT & SAM-40 & 98.6 & 98.3 & $-$0.4 & NS \\
EEGMAT & WESAD & 98.4 & 98.1 & $-$0.6 & NS \\
\bottomrule
...
Remarkably, cross-paradigm transfer succeeds uniformly across all dataset pairs with accuracy exceeding 98\%. This demonstrates that our model learns universal stress representations that generalize across cognitive arithmetic stress (serial subtraction in EEGMAT), emotional stress (SAM-40), and physiological stress (TSST protocol in WESAD). The success validates our hypothesis that stress manifests through common neurophysiological signatures regardless of the specific stressor type.
