...
\caption{Confusion matrices for stress classification across SAM-40 (4-class) and EEGMAT (2-class) datasets. The diagonal dominance indicates strong classification performance with minimal confusion between stress and baseline states.}
