...
\begin{tabular}{lccc}
\toprule
\textbf{Band} & \textbf{SAM-40} & \textbf{WESAD} & \textbf{$p$} \\
\midrule
Delta & +0.42 & +0.35 & $<$.01 \\
Theta & +0.68 & +0.55 & $<$.001 \\
Alpha & $-$0.89 & $-$0.75 & $<$.001 \\
...
\midrule
SAM-40 & EEGMAT$^*$ & 49.0 & 51.9 & $-$50.0 & $<$0.001 \\
\bottomrule
...
\caption{Cross-dataset transfer learning accuracy heatmap. Diagonal entries show within-dataset performance; off-diagonal entries reveal transfer degradation. SAM-40$\rightarrow$EEGMAT shows largest domain gap ($-$50.0\%).}
\label{fig:transfer_heatmap}
\end{figure}

The most pronounced transfer failure? SAM-40 to EEGMAT, with a 50\% decrement. This is sensible upon reflection---cognitive task stress (SAM-40) and pure arithmetic stress (EEGMAT) presumably activate partially overlapping but distinct cerebral networks. SAM-40 and WESAD exhibit reasonable compatibility, conceivably because both blend emotional and cognitive components in their protocols.
