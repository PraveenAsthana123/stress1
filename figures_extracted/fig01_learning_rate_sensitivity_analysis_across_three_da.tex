...
\addplot[color=eegcolor, mark=*, thick, mark size=2pt] coordinates {
    (1e-5, 78.2) (3e-5, 86.4) (1e-4, 94.7) (3e-4, 91.2) (1e-3, 72.5)
};
\addlegendentry{DEAP}

\addplot[color=ragcolor, mark=square*, thick, mark size=2pt] coordinates {
    (1e-5, 75.8) (3e-5, 84.1) (1e-4, 93.2) (3e-4, 89.5) (1e-3, 70.1)
};
\addlegendentry{SAM-40}

\addplot[color=llmcolor, mark=triangle*, thick, mark size=2pt] coordinates {
    (1e-5, 73.5) (3e-5, 82.7) (1e-4, 91.8) (3e-4, 87.3) (1e-3, 68.9)
};
\addlegendentry{Kaggle}
\end{axis}
\end{tikzpicture}
\end{document}
